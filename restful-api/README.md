...
This project introduces the fundamentals of RESTful APIs, HTTP/HTTPS communication, and how to consume APIs using command-line tools such as curl.
...
| POST | Sends data to the server | Creating a new user |
| PUT | Updates existing data | Updating user information |
| DELETE | Removes data from the server | Deleting a resource |
...
To verify that curl is installed on the system, the following command was executed:
